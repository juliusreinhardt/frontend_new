...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {"title":"frontend","meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"hid":"description","name":"description","content":""}],"link":[{"rel":"icon","type":"image\u002Fx-icon","href":"\u002Ffavicon.ico"}],"script":[],"style":[]},
  ...
  if (process.client && typeof nuxt_plugin_vuescrollmagic_459ef1fa === 'function') {
    await nuxt_plugin_vuescrollmagic_459ef1fa(app.context, inject)
  }
